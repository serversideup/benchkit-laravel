...
class SubmissionTest extends TestCase
{
    ...
    public function test_the_issue_carries_the_bot_marker_a_readable_summary_and_the_token(): void
    {
        $id = $this->seedSensitiveRun();
        ...
        $this->assertStringContainsString('**fpm-nginx (Quick)** · DigitalOcean · 4 vCPU', $body);
        $this->assertStringContainsString('12,481 req/s (json)', $body);
        $this->assertStringContainsString('p95 2.14 ms', $body);
    }
