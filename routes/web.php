...
// GET prepares a submission; POST records that one was opened.
Route::get('/runs/{id}/submission', [RunController::class, 'submission'])->where('id', '[0-9]{8}-[0-9]{6}-[a-z0-9]{4}');
Route::post('/runs/{id}/submission', [RunController::class, 'markSubmitted'])->where('id', '[0-9]{8}-[0-9]{6}-[a-z0-9]{4}');
