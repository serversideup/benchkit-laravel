...
- `tests/` (PHPUnit, self-contained with SQLite `:memory:`) and `app/Benchmarks/` (phpbench) are unrelated — do not mix their conventions. `tests/` currently contains only the stock skeleton examples.
