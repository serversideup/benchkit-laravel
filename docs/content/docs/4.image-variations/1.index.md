...
**Neither side is tuned out of the box.** Compare tuned against tuned, and say which tuning you used. [Common tuning strategies](/docs/configuration/common-tuning-strategies#worker-mode-frankenphp-and-octane) explains why.
