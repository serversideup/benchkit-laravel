...
Paste it on a machine near your server with [oha](https://github.com/hatoo/oha) installed. It connects, and the run starts on its own. [Testing from another machine](/docs/benchmarks/testing-from-another-machine) covers how to pick that machine and how to install oha on it.
