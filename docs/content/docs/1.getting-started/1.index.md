...
We created BenchKit to standardize that learning process. Benchmarking honestly is difficult, which is a big reason we open sourced it. We want to build a community of people who are interested in PHP performance tuning with Laravel, so we made a [community gallery of results](/results) where people share their runs and compare notes.
