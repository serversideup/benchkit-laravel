...
When you want the absolute number, open **Test from your own machine** in the app. It gives you the same oha commands to copy, pointed at your server. Drive the load from your own laptop or from another server, and the generator comes off the box entirely.
